...
<main class="sell">
    ...
    @csrf
        <section class="sell__section sell-image">
            <h3 class="sell__subheading">商品画像</h3>
            <div class="sell-image__drop">
                <input type="file" name="image" id="image" class="sell-image__input" accept=".jpeg,.png">
            ...
            <div class="sell-category">
                ...
                <div class="sell-chips">
                    @foreach($categories as $category)
                        <button type="button"
                                class="sell-chip {{ collect(old('category_ids', []))->contains($category->id) ? 'is-selected' : '' }}" data-category-id="{{ $category->id }}">
                        {{ $category->name }}
                        </button>
                    @endforeach
                </div>
                <div id="selectedCategoriesBucket"></div>
                @error('category_ids')
                <p class="sell__error">{{ $message }}</p>
                @enderror
            </div>
        ...
        <section class="sell__section sell-condition">
            <h2 class="sell__subheading">商品の状態</h2>
        ...
        <section class="sell__section sell-basic">
            <h2 class="sell__section-title">商品名と説明</h2>
            <label class="sell-group">
                <span class="sell-group__label">商品名</span>
            ...
            <label class="sell-group">
                <span class="sell-group__label">ブランド名</span>
            ...
            <label class="sell-group">
                <span class="sell-group__label">商品の説明</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    renderHidden(Array.from(selectedIds));
